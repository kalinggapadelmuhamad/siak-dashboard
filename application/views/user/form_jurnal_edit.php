                ...
                <div class="col-12 my-3 form-1">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="jenis_saldo" class="form-control saldo" id="" value="<?= $data->jenis_saldo ?>" readonly>
...
// Mengubah format Rupiah pada Saldo Debit
saldoDebitInput.value = formatRupiah(parseFloat(saldoDebitInput.value.replace(/\D/g, '')), 'Rp. ');
			});
