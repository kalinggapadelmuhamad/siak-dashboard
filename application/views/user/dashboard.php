                          ...
                          <div class="media align-items-center">
                              <span class="avatar avatar-sm rounded-circle">
                                  <img alt="Image placeholder"
                                      src="<?= base_url('assets/img/theme/team-4-800x800.jpg') ?>">
                              </span>
											...
											<table class="table align-items-center table-flush">
												...
												<tbody>
														...
														<tr class="bg-success">
																...
																<td></td>
																<td class="text-white" style="font-weight:bolder;font-size:19px"><?=  $totalDebit ?></td>
														</tr>
												</tbody>
											</table>
										</div>
                      ...
                      <div class="row align-items-center">
                        <div class="col">
                          <h3 class="mb-0">Laba Rugi</h3>
											...
											<tbody>
													...
													foreach ($data as $group) {
															foreach ($group as $transaction) {
																	$jenis_saldo = $transaction->jenis_saldo;
																	$saldo = intval($transaction->saldo);

																	if ($jenis_saldo === 'kredit') {
																			$kredit += $saldo;
													?>
																			<tr>
																					<td><?= $transaction->no_reff?></td>
																					<td><?= $transaction->nama_reff ?></td>
																					<td>-</td>
													...
													<tr class="bg-light">
															<td class="" colspan="3"><b>Total Pendapatan</b></td>
															<td class=""><b><?= 'Rp. ' . number_format(abs($kredit), 0, ',', '.') ?></b></td>
													</tr>
											</tbody>
										</table>
										</div>
										...
										<table class="table">
											<thead class="">
														<td class="" colspan="1"><b>Biaya</b></td>
											</thead>
											<thead class="thead-light">
													<tr>
															<th scope="col">No. Akun</th>
											...
											<tbody>
													...
													<tr class="bg-light">
															<td class="" colspan="3"><b>Total Biaya</b></td>
															<td class=""><b><?= 'Rp. ' . number_format(abs($debit), 0, ',', '.') ?></b></td>
													</tr>
													<tr class="bg-success">
																<td colspan="2" class="text-white" style="font-weight:bolder;font-size:19px">Laba/Rugi</td>
																<td></td>
																<td class="text-white" style="font-weight:bolder;font-size:19px"><?= $kredit - $debit ?></td>
														</tr>
											</tbody>
										</table>
										</div>
